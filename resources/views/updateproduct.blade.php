...
<h3 style="text-align:center;position:relative;top:10px;">Update Product</h3><a class="backbtn" href="/home" role="button" style="position:relative;left:90%;bottom:30%;text-decoration: none;">Back</a>
    </div>
    <form action="updatedatas" mathod="post">
        @csrf
        <div class="firstdiv">
            <img src="/{{$product['image']}}" style="heigth:200px;width:140px;"><input type="file" name='image'>
        </div>
       <div class="form-row">
